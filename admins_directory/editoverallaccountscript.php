           ...
           /* echo $fm_date."<br>";
            ...
            `typeQuantity`='$fm_quality', `transactionChannel`='$fm_channel', `transactionType`='$fm_type', `incomeAmount`='$fm_income', `expenditureAmount`='$fm_expenditure',`lastUpdate`='$lastupdate', `updatedBy`= '$postedby' WHERE `transactionId`='$fm_id'");
                    ...
                    if($update){
                        ...
                        header("Refresh: 2; url=/adminsAccounts/editoverallaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page");
                        ...
                        echo "<a href='/adminsAccounts/editoverallaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page' class='backlink'>Please go back to the previous page!</a></div>";
                    }
                    ...
                    echo "<a href='/adminsAccounts/editoverallaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page' class='backlink'>Please go back to the previous page!</a><br>
                    $db_postedby<br></div>";
