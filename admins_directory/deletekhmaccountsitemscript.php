...
<?php
        if (isset($_GET['trid']) & isset($_GET['mid']) & isset($_GET['yid']) & isset($_GET['page'])){
         ...
         if(!isset($_GET['Answer'])) {echo "<br><br<br>";  
            echo "<div class='register'>
            <br><br>
            Are you sure you want to delete that item with id number $id ?<br>
            
            <a href='/two_dimensionmaster/overallaccounts/deletekhmaccountsitemscript.php?mid=$mid&yid=$yid&trid=$id&page=$page&Answer=NO'>NO</a> &nbsp;&nbsp;<a href='/two_dimensionmaster/overallaccounts/deletekhmaccountsitemscript.php?mid=$mid&yid=$yid&trid=$id&page=$page&Answer=YES'>YES</a>
        ...
        $query = mysqli_query($connect, "DELETE FROM `khm_overall_accounts` WHERE `acc_id`= '$id'");
        ...
        echo '<a href="/two_dimensionmaster/overallaccounts/manageoverallaccounts.php?mid=$mid&yid=$yid&trid=$id&page=$page">Back to previous Page</a><br><br>'; 
        echo "</div>";
