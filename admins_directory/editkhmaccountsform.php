...
$num_of_pages = ceil($totaloutcome/$per_page);
    ...
    <div class="maindivtop">
        ...
        <input type='text' name='quantity' value='$es_quantity'>
        <input type='text' name='type' value='$es_type' > 
        
        
        <select name='category'>
        <option value='$es_category'>$es_category</option>
        <option>Income</option>
        <option>Expenditure</option>
        <option>On Credit Expenditure</option>
        </select>  
       ...
       echo "<div class='tablewrapper'>";
        ...
        echo "<tr><th id='dateclm'>Date</th><th class='mythdata'>Month</th><th class='mythdata'>Year</th><th class='mythdata'>Code</th><th class='mythdata'>Description</th><th class='mythdata'>Quantity</th><th class='mythdata'>Type</th>
        <th class='mythdata'>Category</th><th id='amountclm'>Income</th><th id='amountclm'>Expenditure</th><th id='amountclm'>On Credit</th>";
        ...
        <td class='mythdata'>$year</td><td class='mythdata'>$code</td><td class='mythdata'>$descr</td><td class='mythdata'>$quantity</td><td class='mythdata'>$type</td><td class='mythdata'>$category</td>
        <td class='amounttd'>$income</td><td class='amounttd'>$expenditure</td><td class='amounttd'>$oncredit</td>
        </tr>";
        
        }
        
        echo "<tr><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td>
