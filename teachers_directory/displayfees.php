...
$num_of_pages = ceil($totaloutcome/$per_page);
    ...
    <select name='curryear'>
        ...
        <td class='amounttd'>$amount</td><td class='amounttd'>$standing</td><td class='edittd'><a class='editlink' href='editfeeform.php?mid=$mid&yid=$yid&incid=$id&page=$page'>Edit</a></td></tr>";
