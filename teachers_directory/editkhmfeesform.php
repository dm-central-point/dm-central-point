...
if(isset($_GET['yid']) & isset($_GET['mid']) & isset($_GET['page'])){
    ...
    <div class="maindivtop">
        ...
        echo "<form class='accform_edit' method='post'action='editfeescript.php'>
        ...
        echo '<a  class="backlink" href="displayfees.php?yid='.$yid.'&mid='.$mid.'&page='.$page.'" >Back to previous page</a><br>';  
