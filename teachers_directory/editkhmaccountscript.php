...
echo "<br><br>"; 
 ...
 if(!empty($fm_date) & !empty($fm_month) & !empty($fm_year) & !empty($fm_code) & !empty($fm_descr) & !empty($fm_type)){
 ...
 /*
    ...
    */
       ...
       $insert = mysqli_query($connect, "INSERT INTO `khm_overall_accounts_changebackup`(`month_id`, `year_id`, `acc_date`, `acc_month`, `acc_year`, `acc_code`, `acc_descr`, `acc_type`, `acc_income`, `acc_expenses`, `acc_oncreditExp`, `recordedby`, `updetedby`, `lastupdate`)  
       VALUES ('$db_mid', '$db_yid', '$db_date', '$db_month', '$db_year', '$db_code', '$db_descr', '$db_type', '$db_income', '$db_expenditure','$db_oncredit', '$db_recordedby', '$updatedby', '$lastupdate')"); 
    ...
    VALUES ( '$db_mid', '$db_yid', '$db_date', '$db_month', '$db_year', '$db_code', '$db_descr', '$db_quantity', '$db_type', '$db_category', '$db_income', '$db_expenditure', '$db_recordedby', '$updatedby', '$lastupdate')");    */
     ...
     if($insert){
         ...
         /*
           ...
           `acc_Type`='$fm_type', `incomeAm`='$fm_income', `expenditureAm`='$fm_expenditure',`oncreditExpenditure`='$fm_oncredit', `lastUpdated`='$lastupdate', `updatedBy`= '$updatedby' 
          WHERE `acc_id`='$fm_id'");
