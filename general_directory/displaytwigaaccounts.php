...
$num_of_pages = ceil($totaloutcome/$per_page);
        ...
        $previous = $page - 1;
        $paginationDisplay .='<a href="'.$_SERVER['PHP_SELF'].'?page='.$previous.'&yid='.$yid.'&mid='.$mid.'"> Back </a>';
        }
        ...
        $next = $page + 1;
        $paginationDisplay .=' <a href="'.$_SERVER['PHP_SELF'].'?page='.$next.'&yid='.$yid.'&mid='.$mid.'"> Next </a>';
    ...
    <div class="maindivtop">
        ...
        echo "<form class='accform' method='post'action='twigaaccountscript.php'>
       ...
       echo "<div class='tablewrapper'>";
        ...
        <td class='edittd'><a class='editlink' href='edittwigaaccountsform.php?mid=$mid&yid=$yid&trid=$id&page=$page'>Edit</a></td></tr>";
        ...
        echo '<a  class="backlink" href="twigaaccountspage.php" >Back to the main page</a><br>';  
