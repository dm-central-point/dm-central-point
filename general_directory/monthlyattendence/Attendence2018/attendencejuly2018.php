...
<html>
<head>
   <title>Attendence-july2018</title>         
<?php 
    ...
    <div class="mainwrapper">
         <!-- The main contant goes here -->
            <div class="maindiv">
                ...
                $countquery = "SELECT COUNT(Att_id) FROM khmattendance WHERE Month ='July' AND Year ='2018'";
                ...
                if(!isset($_GET['page'])){
                    ...
                    header('Location: attendencejuly2018.php?page=1');
            ...
            if($page != $num_of_pages){
                ...
                $sql = "SELECT * FROM khmattendance WHERE `Month` = 'July' AND `Year` = '2018' ORDER BY Date DESC LIMIT $start, $per_page ";
