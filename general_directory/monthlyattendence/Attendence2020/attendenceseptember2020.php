...
<html>
<head>
   <title>Attendence-september2020</title>         
<?php 
    ...
    <div class="mainwrapper">
         <!-- The main contant goes here -->
            <div class="maindiv">
                ...
                $countquery = "SELECT COUNT(Att_id) FROM khmattendance WHERE Month ='September' AND Year ='2020'";
                ...
                if(!isset($_GET['page'])){
                    ...
                    header('Location: attendenceseptember2020.php?page=1');
            ...
            if($page != $num_of_pages){
                ...
                $sql = "SELECT * FROM khmattendance WHERE `Month` = 'September' AND `Year` = '2020' ORDER BY Date DESC LIMIT $start, $per_page ";
