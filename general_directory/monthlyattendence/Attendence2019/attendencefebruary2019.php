...
<html>
<head>
   <title>Attendence-february2019</title>         
<?php 
    ...
    <div class="mainwrapper">
         <!-- The main contant goes here -->
            <div class="maindiv">
                ...
                $countquery = "SELECT COUNT(Att_id) FROM khmattendance WHERE Month ='February' AND Year ='2019'";
                ...
                if(!isset($_GET['page'])){
                    ...
                    header('Location: attendencefebruary2019.php?page=1');
            ...
            if($page != $num_of_pages){
                ...
                $sql = "SELECT * FROM khmattendance WHERE `Month` = 'February' AND `Year` = '2019' ORDER BY Date DESC LIMIT $start, $per_page ";
