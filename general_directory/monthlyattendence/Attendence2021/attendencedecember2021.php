...
<html>
<head>
   <title>Attendence-december2021</title>         
<?php 
    ...
    <div class="mainwrapper">
         <!-- The main contant goes here -->
            <div class="maindiv">
                ...
                $countquery = "SELECT COUNT(Att_id) FROM khmattendance WHERE Month ='December' AND Year ='2021'";
                ...
                if(!isset($_GET['page'])){
                    ...
                    header('Location: attendencedecember2021.php?page=1');
            ...
            if($page != $num_of_pages){
                ...
                $sql = "SELECT * FROM khmattendance WHERE `Month` = 'December' AND `Year` = '2021' ORDER BY Date DESC LIMIT $start, $per_page ";
