...
$num_of_pages = ceil($totaloutcome/$per_page);
    ...
    <div class="maindivtop">
        ...
        echo "<form class='accform_edit' method='post'action='edittwigaaccountscript.php'>
       ...
       echo "<div class='tablewrapper'>";
        ...
        echo '<a  class="backlink" href="displaytwigaaccounts.php?yid='.$yid.'&mid='.$mid.'&page=1" >Back to previous page</a><br>';  
