...
if($insert){
    ...
    header("Refresh: 2; url=/twiga_directory/twigaaccounts/displaytwigaaccounts.php?yid=$yid&mid=$mid&page=$page");
    ...
    echo "<a href='/twiga_directory/twigaaccounts/displaytwigaaccounts.php?yid=$yid&mid=$mid&page=$page' class='backlink'>Please go back to the previous page!</a></div>";
}
}else{
