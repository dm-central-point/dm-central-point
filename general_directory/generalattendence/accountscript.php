...
if($insert){
    ...
    header("Refresh: 2; url=/stakeholders_directory/accountsnewformats/displaygeneralaccounts.php?yid=$yid&mid=$mid&page=1");
    ...
    echo "<a href='/stakeholders_directory/accountsnewformats/displaygeneralaccounts.php?yid=$yid&mid=$mid&page=1' class='backlink'>Please go back to the previous page!</a></div>";
}
}else{
