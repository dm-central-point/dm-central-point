...
$num_of_pages = ceil($totaloutcome/$per_page);
    ...
    <div class="maindivtop">
        ...
        echo "<form class='accform_edit' method='post'action='editaccountscript.php'>
        ...
        <input type='text' name='description' value='$descr' > 
        ...
        <input type='number' name='expenditure' value='$expenditure'>
       ...
       echo "<div class='tablewrapper'>";
        ...
        echo '<a  class="backlink" href="displaygeneralaccounts.php?yid='.$yid.'&mid='.$mid.'&page='.$page.'" >Back to previous page</a><br>';  
