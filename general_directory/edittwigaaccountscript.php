           ...
           /* echo $fm_date."<br>";
            ...
            `typeQuantity`='$fm_quality', `transactionChannel`='$fm_channel', `transactionType`='$fm_type', `incomeAmount`='$fm_income', `expenditureAmount`='$fm_expenditure',`lastUpdate`='$lastupdate', `updatedBy`= '$postedby' WHERE `transactionId`='$fm_id'");
                    ...
                    if($update){
                        ...
                        header("Refresh: 2; url=/twiga_directory/twigaaccounts/edittwigaaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page");
                        ...
                        echo "<a href='/twiga_directory/twigaaccounts/edittwigaaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page' class='backlink'>Please go back to the previous page!</a></div>";
                    }
                    ...
                    echo "<a href='/twiga_directory/twigaaccounts/edittwigaaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page' class='backlink'>Please go back to the previous page!</a><br>
                    $db_postedby<br></div>";
            ...
            echo '<div class="datamsg">No data was found!<br>';
             echo "<a href='/twiga_directory/twiaaccounts/edittwigaaccountsform.php?yid=$fm_yid&mid=$fm_mid&trid=$fm_id&page=$fm_page' class='backlink'>Please go back to the previous page!</a></div>";
