...
<html>
<head>
   <title>Problematic-children-form</title>         
<?php 
        ...
        <div class="mainwrapper">
         <!-- The main contant goes here -->
            <div class="maindiv">
            		...
            		<form class="generalaccountform3 col-6" action="problematicchildscript.php" method="POST">
            		    <h2 class="myth">Attendence form</h2></th>
					
					<h4>Day problem reported</h4>
					<input type="date" name="reportdate" class="text" >
					<input type="text" name ="childname" class="text" placeholder="Child's Name">
					
					<select name ="groupname" class="text" >
					...
					<select name ="teachername" class="text" >
						<option value=''>-Select Teacher Here-</option>
						<option>Frida Swai</option>
						<option>Roseline Mushi</option>
						<option>Grace Lemka</option>
						<option>Hawa Yassin</option>
						<option>Oliva Marandu</option>
						<option>Namnyak</option>
						<option>Noela Gabriel</option>
						<option>Julieth </option>
						<option>Oliva Marandu</option>
						<option>Yusufu Mwajah</option>
					</select>
					<input type="text" name="problem" class="text" placeholder="Problem to be reported">
				
				
						<select name ="howbad" class="text" >
						<option value=''>-Select Level of urgency Here-</option>
						...
						<h4>Day problem discovered</h4>
					<input type="date" name="datediscovered" class="text" >
					<select name ="monthdiscovered" class="text" >
				   	...
				   	<select name ="yeardiscovered" class="text" >
					...
					<input type="text" name="suggestion" class="text" placeholder="Suggested Solution">
