...
<body>
<a id="formbtn" onclick="loadForm()"> << </a>
...
echo "<form class='accform' id='accformgeneral' method='post'action='familyaccountscript.php'>
...
<input type='text' name='quality' placeholder='Explain type or quantity'>

<select name='channel'>

<option value=''>Select Channel Here...</option>
<option value='Food and drinks'>Food and drinks</option>
<option value='Outfits and decorations'>Outfits and decorations</option>
<option value='Medication and treatment'>Medication and treatment</option>
<option value='Public relation'>Public relation</option>
<option value=' Family and support'>Family and support</option>
<option value='Family_Educational_Funding'>Family_Educational_Funding</option>
...
echo "<tr><th id='dateclm'>Date</th><th class='mythdata'>Month</th><th class='mythdata'>Year</th>
<th class='mythdata'>Description</th><th class='mythdata'>Type</th><th class='mythdata'>Channel</th><th class='mythdata'>Category</th><th id='amountclm'>Income</th><th id='amountclm'>Expenditure</th><th id='amountclm'>Settings</th></tr>";
...
<td class='mythdata'>$year</td><td class='mythdata'>$descr</td><td class='mythdata'>$type</td><td class='mythdata'>$channel</td><td class='mythdata'>$trtype</td><td class='amounttd'>$income</td><td class='amounttd'>$expenditure</td>
<td class='edittd'><a class='editlink' href='editaccountsform.php?mid=$mid&yid=$yid&trid=$id&page=$page'>Edit</a></td></tr>";
}

echo "<tr><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'></td><td class='bottomrow'>Total income</td>
...
echo "<tr><td class='bottomrow2'></td><td class='bottomrow2'></td><td class='bottomrow2'></td><td class='bottomrow2'></td></td><td class='bottomrow2'></td><td class='bottomrow2'></td><td class='bottomrow2'></td><td class='bottomrow2'>Balance</td>";
...
echo '<a  class="backlink" href="https://thedminfopoint.com/generalAccounts/generalAccountsPage.php" >Back to the main page</a><br>';  
