...
$num_of_pages = ceil($totaloutcome/$per_page);
        ...
        echo "<form class='accform' id='accformgeneral' method='post'action='accountscript.php'>
        ...
        <option>Outfits and decorations</option>
        <option>Medication and treatment</option>
        <option>Public relation</option>
        <option>Family and support</option>
        <option>Family_Educational_Funding</option>
        <option>Other</option>
       ...
       echo "<div class='tablewrapper'>";
        ...
        echo '<a  class="backlink" href="accountscentre.php" >Back to the main page</a><br>';  
