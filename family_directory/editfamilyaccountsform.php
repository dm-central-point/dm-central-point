...
$num_of_pages = ceil($totaloutcome/$per_page);
    ...
    <div class="maindivtop">
        ...
        echo "<form class='accform_edit' method='post'action='editfamilyaccountscript.php'>
       ...
       echo "<div class='tablewrapper'>";
        ...
        echo '<a  class="backlink" href="displayfamilyaccounts.php?mid='.$mid.'&yid='.$yid.'&page='.$page.'" >Back to the previous page</a><br>';  
